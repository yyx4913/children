...
<title>首页</title>
	...
	<frameset border="1" framespacing=1 rows="115, *,50"  bordercolor="#8B8B8B">
        <frame name=header src="/index.php/Index/header.html" frameborder="1" noresize scrolling=no>
            <frameset cols="240, *">
                <frame name=left src="/index.php/Index/left.html" frameborder=1 noresize scrolling=1>
                <frame name=right src="/index.php/Index/sysInfo.html" frameborder=0 noresize scrolling=1 >
            </frameset>
