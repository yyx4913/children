...
<body style="background:#F0F2F5;">
	<div class="container ">
		<center><h1 class="text-info">学生信息列表</h1></center>
		
		<div class="text-right"><form action="/index.php/Stu/all_stu.html" method="post"  class="noprint"><input type="submit" name="submit" value="搜索" style="float:right;margin-left:1.5em;" >
		...
		<table class="table-bordered" id="mytable" style="width:100%;text-align:center; margin-top:1em;">
			...
			<?php if(is_array($info)): foreach($info as $k=>$v): ?><tr> 
			  ...
			  href='/index.php/Stu/del_stu1/stu_id/<?php echo ($v["stu_id"]); ?>&<?php echo ($v["c_id"]); ?>' title="删除该学生信息"><div class="glyphicon glyphicon-trash"></div></a></td>
	...
	<center class="noprint"><a href="/index.php/Stu/add_stu"><button class="btn btn-info  btn-lg">添加学生</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="打&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;印" class="btn btn-primary btn-lg " onclick="p()"></center>
</body>
