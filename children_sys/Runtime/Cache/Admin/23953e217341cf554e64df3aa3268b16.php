        ...
        <div class="row">
            <div class="col-md-2">
                <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
                    <li class="active">
                        <a href="/index.php/Stu/stu_list" target="right"><i class="glyphicon glyphicon-th-large"></i> 功能管理菜单  </a>
                    </li>
                     <li>
                        <a href="#systemSetting3" class="nav-header collapsed" data-toggle="collapse" >
                            <i class="glyphicon glyphicon-home"></i> 安全管理
                    ...
                    <li>
                        ...
                        <ul id="systemSetting4" class="nav nav-list collapse secondmenu" style="height: 5px;">
                            <li><a href="/index.php/Class/class_list" target="right"><i class="glyphicon glyphicon-th-list"></i>&nbsp;&nbsp;本班信息</a></li>
                            <li><a href="/index.php/Stu/stu_list1" target="right"><i class="glyphicon glyphicon-tags"></i>&nbsp;&nbsp;任课班级信息</a></li>
                            <li><a href="/index.php/Team/team_info" target="right"><i class="glyphicon glyphicon-align-left"></i>&nbsp;&nbsp;教师团队信息</a></li>
                            <li><a href="/index.php/Stu/stu_list" target="right"><i class="glyphicon glyphicon-education"></i>&nbsp;&nbsp;学生信息列表</a></li>
                    ...
                    <li>
                        ...
                        <ul id="systemSetting1" class="nav nav-list collapse secondmenu" style="height: 0px;">
                            ...
                            <li><a href="/index.php/Record/chart/stu_id/<?php echo ($stu_id); ?>" target="right"><i class="glyphicon glyphicon-signal"></i>&nbsp;&nbsp;康复效果折线图</a></li>
