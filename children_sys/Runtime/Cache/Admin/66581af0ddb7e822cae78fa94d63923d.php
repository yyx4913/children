...
<body style="background:#F0F2F5;">
	<div class="container-fluid">
		...
		<table class="table-bordered" id="mytable" style="width:100%;text-align:center; margin-top:2.5em;">
			<tr ><th>编号</th><th>班级名称</th><th>学生人数&nbsp;/&nbsp;个</th><th>教师团队</th>
			<th>操作</th></tr>
			<?php if(is_array($res)): foreach($res as $k=>$v): ?><tr> 
			  ...
			  &nbsp;&nbsp;<a href='/index.php/Team/add_team/c_id/<?php echo ($v["c_id"]); ?>' title="组建教师团队"><div class="glyphicon glyphicon-user"></div></a></td>
			</tr><?php endforeach; endif; ?>
			<tr><td colspan="4"><?php echo ($pagelist); ?></td></tr>
		</table><br/>
		<center><a href="/index.php/Class/add_class" title="创建新班级"><button class="btn btn-info  btn-lg">创建新班级</button></a></center>
	</div>
</body>
</html>